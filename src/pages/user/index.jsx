...
export class UserMessage extends Component {
    ...
    getUserList = () => {
        ...
        ajax({
            method: 'post',
            data: {
                userLevel, userWithDrawAuditStatus, page, size
            },
            api: 'userList'
        }).then(res => {
            console.log(res)
    ...
    render() {
        ...
        return (<div className='banner-list'>
            <Row gutter={24}>
                <Col span={8}>  <Form.Item label="会员等级">

                    <Select value={userLevel} onChange={(e) => {
                        this.setState({
                            userLevel: e
                        })
                    }} style={{ width: 200 }}>
                ...
                <Col span={8}>  <Form.Item label="状态">
                    <Select value={userWithDrawAuditStatus} onChange={(e) => {
                        this.setState({
