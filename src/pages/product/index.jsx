...
export class Product extends Component {
    ...
    constructor(props) {
        ...
        this.columns = [
            ...
            },
            {
                ...
                render:(text)=>{
                    return(
                        <div className='long-title' title={text}>{text}</div>
                    )
                }
            },
            {
    ...
    render() {
        const { dataSource, visible,total,page, detail, imgList, commentsData, type, brandList, CatTotalList, productId } = this.state;
        ...
        return (<div className='banner-list'>
            ...
            >
                {type === '3' ? <Comments data={commentsData} productId={productId} getProductCommentListPage={this.getProductCommentListPage} /> : <Form layout="vertical" hideRequiredMark>
                    ...
                    <Row >
                        <Col span={24}>
                            <Form.Item label="上架开始时间">
                                ...
                                })(<DatePicker renderExtraFooter={() => ''} style={{ width: '100%' }} placeholder="选择开始时间" format="YYYY-MM-DD HH:mm:ss" format="YYYY-MM-DD HH:mm:ss"
                                    showTime />)}
                            </Form.Item>
                        </Col>
                        <Col span={24}>
                            <Form.Item label="上架结束时间">
                                ...
                                })(<DatePicker renderExtraFooter={() => ''} style={{ width: '100%' }} placeholder="选择结束时间" format="YYYY-MM-DD HH:mm:ss"
                                    showTime />
                                )}
                            </Form.Item>
                        </Col>
                    ...
                    <Row >
                        <Form.Item label="主图">
                            <ImgUpload data={imgList} uplaodType="productUpload" />
